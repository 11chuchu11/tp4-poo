...
public class PeliculaDTO extends Data {
    ...
    // agregué este metodo para facilitar la impresión de la película
    // ya que el nombre es un atributo importante y sale una posicion de memoria
    //-Emilio
    @Override
    public String toString() {
        return this.getNombrePelicula();
    }
}
